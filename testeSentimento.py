...
('nossa condolências e negativo a sua perda','negativo'),
('por favor não me abandone','negativo'), 
('não quero ficar sozinha','negativo'), 
('não me deixe sozinha','negativo'), 
('estou abatida','negativo'), 
('ele esta todo abatido','negativo'), 
('tão triste suas palavras','negativo'), 
('seu amor não e mais meu','negativo'), 
('estou aborrecida','negativo'), 
]
